...
/**************************************************************************************************
 Server ASP Cancel Transaction Page
**************************************************************************************************
...
* 12/09/2007 - Mat Peck - New kit version
**************************************************************************************************
* Description
* ===========

* This page perform builds a CANCEL POST first for display on screen, for you to view to contents,
* then POSTs that data to the Gateway to CANCEL the transaction you selected, displaying the
...
{
	/** Now POST the data.
	*** Data is posted to strCancelURL which is set depending on whether you are using SIMULATOR, TEST or LIVE **/
	
	$arrResponse = requestPost($strCancelURL, $strPost);
	...
	if ($strStatus == "OK")
	{
		//An OK status means that the transaction has been successfully CANCELLED **
		...
		$strSQL="UPDATE tblOrders SET Status='CANCELLED - Successful transaction subsequently voided'
...
<html>
<head>
	<title>Sage Pay Server PHP Kit Cancel Transaction Page</title>
...
<body>
    <div id="pageContainer">
        ...
        <div id="content">
			...
			{
				echo "
				This page formats a CANCEL POST to send to Server, to cancel the transaction you selected in the Order Admin area.  The POST is displayed below.  If you wish to go ahead with the CANCEL, click Proceed, otherwise click Back to go back to the admin area.<br>
				<br>
				The code for this page can be found in the cancel.php file.";
			}
	      	else
			{
				echo "
		  		The table below shows the results of the CANCEL.  Click Back to return to the Order Admin area.";
		  	}
			?>
		 	</p>
			...
			<div class="greyHzShadeBar">&nbsp;</div>
			<form name="adminform" action="cancel.php" method="POST">
