...
/**************************************************************************************************
* Server PHP Release Transaction Page
***************************************************************************************************
...
<html>
<head>
	<title>Sage Pay Server PHP Kit Release Transaction Page</title>
...
<body>
    <div id="pageContainer">
        ...
        <div id="content">
			...
			{
				echo " 
		  		This page formats an Release POST to send to the Server, to cancel the DEFERRED transaction you selected in the Order Admin area.  The POST is displayed below.  If you wish to go ahead with the Release, check the ReleaseAmount and click Proceed, otherwise click Back to go Back to the admin area.<br>
				<br>
