...
/**************************************************************************************************
* Server PHP Abort Transaction Page
***************************************************************************************************
...
/** Now to build the Server POST.  For more details see the Sage Pay Server and Direct Shared Protocols 2.23 **
...
<html>
<head>
	<title>Sage Pay Server PHP Kit Abort Transaction Page</title>
...
<body>
    <div id="pageContainer">
        ...
        <div id="content">
			...
			{
				echo "
		  		This page formats an ABORT POST to send to the Server, to cancel the transaction you selected in the Order Admin area.  The POST is displayed below.  If you wish to go ahead with the Abort, click Proceed, otherwise click Back to go back to the admin area.<br>
				<br>
