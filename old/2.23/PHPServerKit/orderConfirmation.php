...
/** Okay, build the post data for Sage Pay Server using the information in our session **
...
<html>
<head>
	<title>Sage Pay Server PHP Kit Order Confirmation Page</title>
        ...
        <div id="content">
			...
			<p>This page summarises the order details and customer information gathered on the previous screens. It is always a good idea to show your customers a page like this to allow them to go back and edit either basket or contact details.<br>
			  ...
			  <? if ($strConnectTo=="SIMULATOR")
			  	echo
				"Because you are using Simulator, clicking Proceed will show you the contents of the POST sent to Sage Pay Server, and the reply sent back.  This will illustrate how your system should register details with the real Sage Pay Server systems.  When you are in Test or Live modes, this page will not display results or wait for your input, it will simply redirect the customer to the payment pages, or handle any registration errors sent back by Sage Pay Server.";
			  	else
				echo
				"Since you are in " . $strConnectTo . " mode, clicking Proceed will register your transaction with Sage Pay Server and automatically redirect you to the payment page, or handle any registration errors.  The code to do this can be found in transactionRegistration.php";
			?>
          	</p>
