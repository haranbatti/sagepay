...
/**************************************************************************************************
* Server PHP Refund Transaction Page
***************************************************************************************************
...
<html>
<head>
	<title>Sage Pay Server PHP Kit Refund Transaction Page</title>
...
<body>
    <div id="pageContainer">
        ...
        <div id="content">
			...
			{
			echo "
			This page formats a REFUND POST to send to the Server, to refund against the transaction you selected in the Order Admin area.  The details are displayed below.  If you wish to go ahead with the Refund, check the Refund Amount and click Proceed, otherwise click Back to go Back to the admin area.<br>
			<br>
