...
/**************************************************************************************************
* Sage Pay Direct PHP Repeat Transaction Page
***************************************************************************************************
...
<html>
<head>
	<title>Sage Pay Direct PHP Kit Repeat Transaction Page</title>
...
<body>
    <div id="pageContainer">
        ...
        <div id="content">
			...
			{
			echo "
		  	This page formats a REPEAT POST to send to the Direct, to Repeat against the transaction you selected in the Order Admin area.  The details are displayed below.  If you wish to go ahead with the Repeat, check the Repeat Amount and click Proceed, otherwise click Back to go Back to the admin area.<br>
			<br>
