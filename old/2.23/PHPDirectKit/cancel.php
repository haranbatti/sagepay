...
/**************************************************************************************************
 Direct ASP Cancel Transaction Page
**************************************************************************************************
...
<html>
<head>
	<title>Sage Pay Direct PHP Kit Cancel Transaction Page</title>
...
<body>
    <div id="pageContainer">
        ...
        <div id="content">
			...
			{
				echo "
				This page formats a CANCEL POST to send to Direct, to cancel the transaction you selected in the Order Admin area.  The POST is displayed below.  If you wish to go ahead with the CANCEL, click Proceed, otherwise click Back to go back to the admin area.<br>
				<br>
