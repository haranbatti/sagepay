...
$strEncryptionPassword="[your Encryption Password]";    /** Set this value to the XOR Encryption password assigned to you by Sage Pay **/
...
$bSendEMail=1; 
$strVendorEMail="[your e-mail address]";    /** Optional setting. Set this to the mail address which will receive order confirmations and failures **/
